    ...
    public partial class Proveedores1 : System.Web.UI.Page
    {
        ...
        protected void gvClientes_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
...

            {
                ...
                int idProveedor = Convert.ToInt32(gvProveedores.DataKeys[indiceFila].Value);
                ...
                try
                {
                    ...
                    ServicioDentaCart.ProveedorDB clienteSeleccionado = clienteServicioWeb.ObtenerProveedorPorId(idProveedor);
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            if (validar())
            {
                // Crear una instancia del cliente del servicio web
                ServicioDentaCart.WebServiceDentaCartSoapClient clienteServicioWeb = new ServicioDentaCart.WebServiceDentaCartSoapClient();
                clienteServicioWeb.InsertarProveedor(txtNombre.Text, txtDni.Text, txtDir.Text, txtCorreo.Text,
                    txtTelefono.Text);
                ...
                ltlAlertaProveedores.Text= "<div class='alert alert-success alert-dismissible fade show' role='alert'>Datos Guardados correctamente.<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>";
                CargarProveedores();
                habilitar(false);
                limpiar();
                btnActualizar.Enabled = false;
            ...
            else
            {
                ...
                ltlAlertaProveedores.Text = "<div class='alert alert-danger alert-dismissible fade show' role='alert'>Error no se puede guardar los datos <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>";
        ...
        {
            ServicioDentaCart.WebServiceDentaCartSoapClient clienteServicioWeb = new ServicioDentaCart.WebServiceDentaCartSoapClient();
            clienteServicioWeb.ActualizarProveedor(Int32.Parse(txtId.Text), txtNombre.Text, txtDni.Text, txtDir.Text, txtCorreo.Text,
                txtTelefono.Text);
            ...
            ltlAlertaProveedores.Text = "<div class='alert alert-success alert-dismissible fade show' role='alert'>Datos Actualizados correctamente.<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>";
        ...
        {
            ServicioDentaCart.WebServiceDentaCartSoapClient clienteServicioWeb = new ServicioDentaCart.WebServiceDentaCartSoapClient();
            clienteServicioWeb.EliminarProveedor(Int32.Parse(txtIdM.Text));
            ...
            ltlAlertaProveedores.Text = "<div class='alert alert-success alert-dismissible fade show' role='alert'>Datos Eliminados correctamente.<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>";
            CargarProveedores();
        }
    }
}