<%@ Page Title="" Language="C#" MasterPageFile="~/Formularios/InicioCuenta.Master" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="DentaCartASP.Formularios.Proveedores1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div class="container">
      <div class="row">
          <div class="col">
              <h4>Formulario de Proveedores</h4><div id="alertaProveedores"> <asp:Literal ID="ltlAlertaProveedores" runat="server"></asp:Literal></div>
              <div class="row">
                  <div class="row p-2">
                      <div class="col-md-12">
      ...
      <div class="row p-2">
          <div class="col">
              <asp:GridView ID="gvProveedores" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-responsive" OnRowCommand="gvClientes_RowCommand1" DataKeyNames="id" OnRowDataBound="gvClientes_RowDataBound">
                  <Columns>
